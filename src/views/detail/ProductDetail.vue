<template>
  <div class="product-detail">
    <product-detail-nav-bar @titleItemClick="titleItemClick" ref="detailNavBar"></product-detail-nav-bar>
    <scroll
      :probe-type="3"
      @backTopScroll="detailScroll"
      class="scroll-height"
      ref="scroll">
      <detail-swiper :swiper-list="topImages" class="detail-set-scroll"></detail-swiper>
      <detail-base-info :goods="goods"></detail-base-info>
      <detail-shop-info :shop="shops"></detail-shop-info>
      <detail-images-info :images-info="detailsInfo" @imgLoad="imgLoad"></detail-images-info>
      <detail-param-info :param-info="paramsInfo" class="detail-set-scroll"></detail-param-info>
      <detail-comment-info :comment-info="commentInfo" class="detail-set-scroll"></detail-comment-info>
      <goods-list :goods="recommendList" :is-recommend="true" class="detail-set-scroll"></goods-list>
    </scroll>
    ...
    methods: {
      ...
      detailScroll(position) {
        ...
        for (let i = 0; i < this.detailClassList.length - 1; i++) {
          if (detailPosition >= this.detailClassList[i].offsetTop && detailPosition <
            this.detailClassList[i + 1].offsetTop) {
